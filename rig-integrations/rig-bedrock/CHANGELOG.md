...
## [Unreleased]
## [0.4.5](https://github.com/gold-silver-copper/rig/compare/rig-bedrock-v0.4.4...rig-bedrock-v0.4.5) - 2026-04-28

### Fixed

- *(bedrock)* preserve adaptive-thinking signatures in streaming reasoning ([#1683](https://github.com/gold-silver-copper/rig/pull/1683)) (by @byQuexo)
- *(bedrock)* handle adaptive-thinking interactions for prompt caching and reasoning conversion ([#1675](https://github.com/gold-silver-copper/rig/pull/1675)) (by @byQuexo)
- *(bedrock)* preserve all parallel tool calls in completion response ([#1626](https://github.com/gold-silver-copper/rig/pull/1626)) (by @aleksmeshr)
