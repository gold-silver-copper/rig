use crate::Embed;
use crate::embeddings::{EmbeddingError, EmbeddingModel, EmbeddingsBuilder};
...
pub trait EmbeddingsClient {
    ...
    /// ```
    fn embedding_model(&self, model: impl Into<String>) -> Result<Self::EmbeddingModel, EmbeddingError>;
    ...
    fn embedding_model_with_ndims(
        ...
        ndims: usize,
    ) -> Result<Self::EmbeddingModel, EmbeddingError>;
    ...
    fn embeddings<D: Embed>(
        &self,
        model: impl Into<String>,
    ) -> Result<EmbeddingsBuilder<Self::EmbeddingModel, D>, EmbeddingError> {
    ...
    fn embeddings_with_ndims<D: Embed>(
        ...
        Ok(EmbeddingsBuilder::new(
            self.embedding_model_with_ndims(model, ndims)?,
        ))
    }
}
