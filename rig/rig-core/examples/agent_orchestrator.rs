...
async fn main() -> Result<(), anyhow::Error> {
    ...
    let classify_agent = openai_client.extractor::<Specification>(rig::models::openai::GPT_4)
        .preamble("
    ...
    let content_agent = openai_client
        .extractor::<TaskResults>(rig::models::openai::GPT_4)
        .preamble(
            "
    ...
    let judge_agent = openai_client
        .extractor::<Specification>(rig::models::openai::GPT_4)
        .preamble(
            "
