...
const LOADERS_GLOB: &str = "crates/rig-core/examples/*.rs";
const LOADERS_PROMPT: &str = "Which example builds an agent from files loaded via FileLoader::with_glob(\"crates/rig-core/examples/*.rs\")? Answer with just the file name.";
