...
- Cover top_n in source ground truth checks (by @gold-silver-copper) - #21
- Tighten SQLite ANN conformance coverage (by @gold-silver-copper) - #21
- Exercise source ground truth in SQLite conformance (by @gold-silver-copper) - #21
- Add SQLite InsertDocuments conformance coverage (by @gold-silver-copper) - #21
- Validate vector fixtures against computed oracle (by @gold-silver-copper) - #21
- Add VIBE vector conformance fixtures (by @gold-silver-copper) - #21
- Generate ANN fixtures from ANN-Benchmarks data (by @gold-silver-copper) - #21
- Add SQLite ANN conformance testkit (by @gold-silver-copper) - #21
