...
//!
//! See the [README](https://github.com/0xPlaygrounds/rig/tree/main/crates/vector-stores/rig-neo4j) for more information.
//!
//! ## Prerequisites
//!
//! ### GenAI Plugin
...
//!
//! ## Simple example:
//! More examples can be found in the [/examples](https://github.com/0xPlaygrounds/rig/tree/main/crates/vector-stores/rig-neo4j/examples) folder.
//! ```ignore
