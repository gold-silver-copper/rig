...
<div style="display: flex; align-items: center; justify-content: center;">
    <picture>
        <source media="(prefers-color-scheme: dark)" srcset="../../../assets/rig_logo_dark.svg">
        <source media="(prefers-color-scheme: light)" srcset="../../../assets/rig_logo.svg">
        <img src="../../../assets/rig_logo.svg" width="200" alt="Rig logo">
    </picture>
