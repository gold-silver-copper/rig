...
pub(super) const TINY_CAP: u64 = 3;
...
async fn blocking_truncated_turn_reports_length_and_cap() {
    {
        ...
        with_anthropic_turn_metadata_cassette(
            ...
            |client| async move {
                {
                    rig::agent(client.completion(anthropic::completion::CLAUDE_HAIKU_4_5))
